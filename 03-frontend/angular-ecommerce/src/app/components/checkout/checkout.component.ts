...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit() {
    console.log("Handling the submission buton");
    ...
    // console.log("Shipping Address: " + this.checkoutFormGroup.get('shippingAddress')!.value.state.name);
    ...
    for (let i = 0; i < cartItems.length; i++) {
      orderItems[i] = new OrderItem(cartItems[1]);
    }
    */
    // short way
    ...
    // populate purchase - customer/shipping address/billing address/order/orderItems
